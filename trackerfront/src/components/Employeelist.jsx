...
function Employeelist() {
  ...
  return (
    <tr key={employee.id}>
      <Employee employee={employee} key={employee.id} delEmployee={delEmployee} updateEmployeeFromList={updateEmployeeFromList} ></Employee>
    </tr>
  );
})}
  </tbody>
...
<Pagination totalEmployees={employees.length} employesPerPage={employesPerPage} setCurrentPage={setCurrentPage} currentPage={currentPage} />
